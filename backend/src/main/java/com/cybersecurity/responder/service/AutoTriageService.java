...
public class AutoTriageService {
    ...
    private static class ThreatTemplate {
        ...
        ThreatTemplate withDetails(String description, String mitigationSteps, String scriptTemplate) {
    ...
    public TriageResult triageAlert(String title, String description) {
        ...
        String report = String.format("""
                ...
                Vulnerability Overview:
                An alert has been captured with unrecognized signatures. Logged payload: %s
